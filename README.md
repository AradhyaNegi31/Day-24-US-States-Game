...
📂 Project Structure us-states-game/ │ ├── main.py ├── 50_states.csv ├── blank_states_img.gif └── README.md 🚀 How to Run 1️⃣ Clone the repository git clone cd us-states-game 2️⃣ Install dependencies pip install pandas 3️⃣ Run the project python main.py 🎮 How to Play
